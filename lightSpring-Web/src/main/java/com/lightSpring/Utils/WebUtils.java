...
import com.lightSpring.DispatcherServlet;
import com.lightSpring.FilterRegistrationBean;
import com.lightspring.Tools.ApplicationContextUtils;
import com.lightspring.Tools.ClassPathUtils;
import com.lightspring.Tools.YamlUtils;
...
public class WebUtils {
    ...
    public static void registerDispatcherServlet(ServletContext servletContext, Properties properties) {
        var dispatcherServlet = new DispatcherServlet(ApplicationContextUtils.getRequiredApplicationContext(), properties);
     ...
     */
    public static Properties createPropertyResolver() {
